...
export default function Licensing() {
  return (
    <>
      <Head>
        <title>Licensing - t8l.dev</title>
        <meta name="description" content="Licensing information for t8l.dev tools - All tools are released under the Unlicense, free for anyone to use, modify, and distribute." />
        <meta name="keywords" content="licensing, unlicense, open source, developer tools, t8l.dev" />
        
        {/* Open Graph */}
        <meta property="og:title" content="Licensing - t8l.dev" />
        <meta property="og:description" content="Licensing information for t8l.dev tools - All tools are released under the Unlicense, free for anyone to use, modify, and distribute." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://t8l.dev/licensing" />
        <meta property="og:image" content="https://t8l.dev/logo_white.png" />
        
        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Licensing - t8l.dev" />
        <meta name="twitter:description" content="Licensing information for t8l.dev tools - All tools are released under the Unlicense, free for anyone to use, modify, and distribute." />
